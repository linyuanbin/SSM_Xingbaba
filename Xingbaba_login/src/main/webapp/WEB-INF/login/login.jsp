...
$(function(){
	$("#loginsubmit").click(function(){ //jquery对id为loginsubmit的控件绑定submit事件
		$("#loginForm").submit(); //提交登录表单
	});
});
</script>
</head>
				...
				<div class="login-form">
					<div class="login-box">
						...
						<div class="msg-wrap">
							...
							<div <c:if test="${empty error }"> style="display:none;" </c:if> class="msg-error"> <!--msg-error 红色字样式-->
								<b></b>${error }
							</div>
						</div>
						<div class="mc">
