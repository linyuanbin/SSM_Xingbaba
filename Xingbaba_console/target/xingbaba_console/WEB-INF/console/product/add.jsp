...
function uploadPic(){
	...
	$("#jvForm").ajaxSubmit(options); //jquery.form.do
}
</script>
</head>
<body>
		...
		<table cellspacing="1" cellpadding="2" width="100%" border="0" class="pn-ftable">
			...
			<tbody id="tab_2" style="display: none">
				...
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h"></td>
						<td width="80%" class="pn-fcontent">
						<input type="file" onchange="uploadPic()" name="pics" multiple="multiple"/> <%--multiple="multiple"可以选多个数据--%>
					</td>
				</tr>
			</tbody>
			<tbody id="tab_3" style="display: none"> <%--富文本编辑器--%>
				<tr>
					<td >
