		...
		<div id="show">
			...
			<div class="cart-inner">
				<div class="cart-thead clearfix">
					...
					<div class="column t-price">L君价</div>
						...
						<div id="product_11345721" class="item item_selected ">
							<div class="item_form clearfix">
								...
								<div class="cell p-inventory stock-11345721">
									<c:if test="${item.have }">有货</c:if>
                                 	<c:if test="${!item.have }">无货</c:if>
								</div>
				...
				<div class="cart-toolbar clearfix">
					<div class="total fr">
						<p>
							<span class="totalSkuPrice">¥${buyerCart.productPrice }</span>商品金额： <!--$ {buyerCart.productPrice }-->
						</p>
						<p>
							<span id="totalRePrice">- ¥${buyerCart.fee}</span>运费：<!--$ {buyerCart.fee}-->
						</p>
					</div>
					<div class="amout fr">
						<span id="selectedCount">${buyerCart.productAmount }</span> 件商品 <!--$ {buyerCart.productAmount } -->
					</div>
				</div>
				<div class="ui-ceilinglamp-1" style="width: 988px; height: 49px;">
					<div class="cart-dibu ui-ceilinglamp-current"
						...
						<div class="cart-total-2014">
							...
							<div class="total fr">
								总计： <span class="totalSkuPrice">¥${buyerCart.totalPrice }</span> <!--$ {buyerCart.totalPrice } -->
							</div>
						</div>
					</div>
				</div>
